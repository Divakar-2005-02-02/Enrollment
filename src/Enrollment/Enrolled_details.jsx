...
const EnrolledSubjects = () => {
  ...
  useEffect(() => {
    ...
    const fetchEnrolledSubjects = async () => {
      try {
        const enrolledResponse = await axios.get('http://51.20.18.18:8080/enroll/get-id', {
          params: { studentId },
        });
        ...
        const subjectStaffPromises = enrolledResponse.data.map(async (enrollment) => {
          ...
          try {
            const subjectStaffResponse = await axios.get('http://51.20.18.18:8080/enroll/get-subject-staff', {
